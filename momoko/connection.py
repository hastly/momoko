...
class Pool(object):
    ...
    def mogrify(self, *args, **kwargs):
        ...
        **NOTE:** This is NOT a synchronous method (contary to `momoko.Connection.mogrify`)
        ...
        parameters.
        """
        return self._operate(Connection.mogrify, args, kwargs, async_param=False)
    ...
    def _operate(self, method, args=(), kwargs=None, async_param=True, keep=False, connection=None):
        kwargs = kwargs or {}
        future = Future()
